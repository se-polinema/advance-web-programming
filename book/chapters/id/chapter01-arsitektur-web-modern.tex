...
\begin{istilahpenting}
\begin{description}[leftmargin=0pt,style=nextline]
  \item[Serverless] Model eksekusi kode sebagai fungsi-fungsi kecil yang hanya berjalan saat dipicu peristiwa, tanpa proses server yang menyala terus-menerus; penyedia cloud yang mengurus infrastrukturnya.
\end{description}
\end{istilahpenting}
